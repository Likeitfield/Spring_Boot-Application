...
public class RegistrationService {
	...
	public void registerUser(User user) throws UserIdAlreadyPresentException{
		...
		UserEntity list = userRepository.saveAndFlush(userEntity);	
		System.out.println("User_name "+list.getName());
		System.out.println("User_Id "+list.getUserId());
		System.out.println("User_Email "+list.getEmail());
		System.out.println("User_PWD "+list.getPassword());
		System.out.println("User_Phone "+list.getPhone());
